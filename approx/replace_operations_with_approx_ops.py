...
non_bn_module_map = {
    ...
    nn.Conv2d: QCustomConv2dTorch, # replace with CustomConv2dTorch
    nn.ConvTranspose1d: QuantConvTranspose1d,
    nn.ConvTranspose2d: QuantConvTranspose,
    nn.Linear: QCustomLinearTorch, # replace with CustomLinearTorch
    nn.LayerNorm: QuantLayerNorm,
}

non_param_modules = (_AdaptiveAvgPoolNd, _AvgPoolNd)
# BN Quant Modules Map
bn_module_map = {nn.Conv1d: BNQConv1d, nn.Conv2d: QCustomBNConv2dTorch, nn.Linear: BNQLinear}

quant_conv_modules = (QuantConv1d, QCustomConv2dTorch, BNQConv1d, QCustomBNConv2dTorch)
