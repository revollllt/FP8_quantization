    ...
    def __init__(self, model_fp, input_size=(1, 3, 224, 224), quant_setup=None, **quant_params):
        ...
        if quant_setup == "FP_logits":
            ...
            for name, module in self.named_modules():
                if isinstance(module, QCustomBNConv2dTorch) and module.groups == module.in_channels:
...
def mobilenetv2_quantized_approx(pretrained=True, model_dir=None, load_type="fp32", **qparams):
