...
from approx.replace_operations_with_approx_ops import quantize_model, Flattener, QuantizedActivationWrapper
...
def resnet18_quantized_approx(pretrained=True, model_dir=None, load_type="fp32", **qparams):
    if load_type == "fp32":
...
def resnet50_quantized_approx(pretrained=True, model_dir=None, load_type="fp32", **qparams):
    if load_type == "fp32":
        # Load model from pretrained FP32 weights
